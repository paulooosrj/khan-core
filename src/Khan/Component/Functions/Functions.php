...
class Router
{
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        return call_user_func_array([$routerrr, $name], $arguments);
    }
}
...
class Container
{
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        return call_user_func_array([$containerrr, $name], $arguments);
    }
}
...
class DB
{
    ...
    public static function __callStatic($name, $arguments)
    {
        ...
        return call_user_func_array([$dbb, $name], $arguments);
    }
}
